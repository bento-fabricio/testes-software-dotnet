...
namespace NerdStore.Vendas.Domain.Tests
{
    public class PedidoTests
    {
        ...
        public void AdicionarItemPedido_ItemExistente_DeveIncrementarUnidadesSomarValores()
        {
            ...
            var pedidoItem = new PedidoItem(produtoId, produtoNome, 2, 100);
            pedido.AdicionarItem(pedidoItem);

            var pedidoItem2 = new PedidoItem(produtoId, produtoNome, 1, 100);
        ...
        public void Pedido_AplicarVoucherInvalido_DeveRetornarComErros()
        {
            ...
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var voucher = new Voucher("PROMO-15-REAIS", null, 15,
                TipoDescontoVoucher.Valor, 1, DateTime.Now.AddDays(-1), true, true);
